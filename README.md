...
| `/api/task-chains` | POST | 创建任务链 |
| `/api/tasks/:id/children` | GET | 获取子任务 |
| `/api/tasks/:id/launch-local` | POST | 本地终端执行任务 |
| `/api/execute-local` | POST | 创建并本地执行任务 |
